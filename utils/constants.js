...
//кнопки открытия
export const popupEditOpeneButton = document.querySelector(".profile__edit-button");
export const popupAddOpeneButton = document.querySelector(".profile__add-button");
//кнопки закрытия
...
export const nameInput = formElementPopupEdit.querySelector(".popup__input_type_name");
export const jobInput = formElementPopupEdit.querySelector(".popup__input_type_job");
